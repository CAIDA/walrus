...
public class H3GraphBuffer
{
	...
	H3SimpleGraph graph = new H3SimpleGraph(m_numNodes, numLinks);
    ...
    private void copyLinks(H3SimpleGraph graph)
    {
    ...
    private static class H3SimpleGraph
	implements H3Graph
    {
	////////////////////////////////////////////////////////////////////
	// CONSTRUCTORS
	...
	public H3SimpleGraph(int numNodes, int numLinks)
	{
	...
	private static class Nodes
	{
	    ...
	    // This is inversely proportional to the distance from the origin
	    // to a node as determined with the hyperbolic metric.
	    ...
	    // Color in packed RGB format (R, G, and B in the lower three
	    // octets).
	    public int[] color;
	}
