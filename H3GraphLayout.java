...
public class H3GraphLayout
{
    ...
    {
	computeRadiiSubtree(graph, layout, 0);
    }
	...
	computeAnglesSubtree(graph, layout, children, 0);
    }
	...
	graph.setNodeLayoutCoordinates(0, H3Transform.ORIGIN4);
	computeCoordinatesSubtree(graph, layout, H3Transform.I4, 0);
    }
